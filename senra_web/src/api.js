...
export const userApi = {
    ...
    getUser: (id, page = 1, perPage = 10) =>
        api.get(`/user/${id}`, { params: { page, per_page: perPage } }),
    updateUser: (data) => api.patch('/user', data),
};

export const notebookApi = {
    listNotebooks: (page = 1, perPage = 10) =>
        api.get('/notebooks', { params: { page, per_page: perPage } }),
    ...
    listComments: (id, page = 1, perPage = 10) =>
        api.get(`/notebooks/${id}/comments`, { params: { page, per_page: perPage } }),
    ...
    listVersions: (id, page = 1, perPage = 10) =>
        api.get(`/notebooks/${id}/versions`, { params: { page, per_page: perPage } }),
};
